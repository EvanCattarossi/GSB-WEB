...
<head>
    <meta charset="UTF-8">
    <title>Gestion des frais - Visiteur</title>
...
<body>
    ...
    <img src="gsb.png" alt="Logo GSB"><nav>
            <ul>
                <li><a href="dashboard_visiteur.php">Accueil</a></li>
    ...
    <main>
        ...
        <button class="button btn-green" onclick="window.location.href='FicheFrais.php'">Renseigner la fiche de frais</button>
            <a href="AfficherFicheFrais.php" class="button blue">Afficher mes fiches de frais</a>
